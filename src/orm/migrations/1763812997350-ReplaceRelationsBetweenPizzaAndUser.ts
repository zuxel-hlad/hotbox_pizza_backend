...
export class ReplaceRelationsBetweenPizzaAndUser1763812997350 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "favorite_pizza" ("usersId" integer NOT NULL, "pizzaListId" integer NOT NULL, CONSTRAINT "PK_590051444b347c3c964b256ddc3" PRIMARY KEY ("usersId", "pizzaListId"))`);
        ...
        await queryRunner.query(`ALTER TABLE "pizza_list" ADD CONSTRAINT "FK_d9c0aa861aac7eb46205e1063a9" FOREIGN KEY ("favoritedById") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "favorite_pizza" ADD CONSTRAINT "FK_07f806d04a779c89dd62605849d" FOREIGN KEY ("usersId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "favorite_pizza" ADD CONSTRAINT "FK_6b87c959e162153c8689749d3bf" FOREIGN KEY ("pizzaListId") REFERENCES "pizza_list"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
